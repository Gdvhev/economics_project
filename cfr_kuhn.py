# -*- coding: utf-8 -*-
"""
Created on Thu Apr 23 19:07:58 2020
...
def is_terminal(history):
    ...
    possibilities = {"nncc": True, "nncrc": True,"nncrr": True, "nnrc": True, "nnrr": True}
...
def terminal_util(history, card_1, card_2):
    ...
    if history == "nncrc" or history == "nnrc":
    ...
    # Showdown with 1 bet
    assert(history == "nncrr" or history == "nnrr")
